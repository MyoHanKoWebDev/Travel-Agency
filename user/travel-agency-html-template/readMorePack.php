        ...
        <div class="row gx-0">
            <div class="col-lg-8 text-center text-lg-start mb-2 mb-lg-0">
                <div class="d-inline-flex align-items-center" style="height: 45px;">
                    ...
                    26th street, between 90th and 91th streets, Mandalay, Myanmar</small>
                            ...
                            <div class="col-md-8">
                                ...
                                <div class="d-flex border-bottom my-4 shadow-sm py-2 wow fadeInUp" data-wow-delay="0.1s">
                                    <small class="flex-fill text-center border-end py-2">
                                        <i class="fa fa-map-marker-alt text-primary me-2"></i><?php echo $row["plName"]; ?></small>
                                    <small class="flex-fill text-center border-end py-2">
                                        <i class="fa fa-hotel text-primary me-2"> </i><?php echo $row["hoName"]; ?></small>
                                    <small class="flex-fill text-center py-2">
                                        <i class="fas fa-car text-primary me-2"></i><?php echo $row["carType"]; ?></small>
                                </div>
                            ...
                            <div class="col-md-4">
                                <div class="card shadow-lg rounded-3 wow fadeInUp" data-wow-delay="0.1s">
                                    <div class="card-body p-4">
                                        ...
                                        <p>
                                            <i class="fas fa-solid fa-user-check text-primary me-2">
                                            </i>Available People:<strong> <?php echo $row["numOfPeo"]; ?> </strong>
                                        </p>
                                        <p>
                                            <?php
                                            ...
                                            ?>
                                                    ...
                                                    <strong><span class="text-primary"> ( <?php echo $remainingSeats; ?> out of <?php echo $row["numOfPeo"]; ?> )
                                                    </span> seats remaining</strong>
                                                <?php } else { ?>
                                                    <i class="fas fa-solid fa-couch text-primary me-2 text-danger"></i>
                                                    <strong class="text-danger">All seats are fully booked.</strong>
                                        </p>
                                    <?php } ?>
                                    </p>
                                    ...
                                    <form action="" method="POST">
                                        ...
                                        <div class="form-floating">
                                            <input type="number" class="form-control bg-transparent rounded-3" id="numOfPeo" 
                                            placeholder="Number Of People" min="1" max="<?php echo $remainingSeats; ?>" name="nOfPeo" oninput="checkSeats(this)">
                                            <label for="numOfPeo">No. Of Persons</label>
                                            <p id="seatWarning" style="display: none;" class="text-danger my-2">
                                                Can't book, <?php echo $remainingSeats > 0 ? $remainingSeats : "No"; ?> seats available!</p>
                                        </div>
