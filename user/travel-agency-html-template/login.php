...
<body>
    ...
    if (isset($_POST["signUp"])) {
        ...
        if (strlen($name) == 0) {
            ...
            $nres = "Must contains alphabets with small and capital letter";
            $valid = false;
        }
        //name end  
        ...
        //phone start
         $phonepattern = "/^[0-9]{5,}$/";
        if (strlen($phone) == 0) {
            $phres = "Please fill name field";
            $valid = false;
        } else if (strlen($phone) < 5) {
            $phres = "Phone Number must contain at least 5 character";
            $valid = false;
        } else if (!preg_match($phonepattern, $phone)) {
            $phres = "Only accept number";
            $valid = false;
        }
        //phone end 
        ...
        if (strlen($pass) == 0) {
            ...
            $pres = "Must include number, capital and small letter";
            $valid = false;
        }
        //password end
            ...
            <div class="col-6 form-container sign-up-container">
                <form class="form" method="post" enctype="multipart/form-data">
                    ...
                    <input type="text" placeholder="Phone Number" class="form-control input" name="phone" required value="<?php echo isset($_POST['phone']) ? htmlspecialchars($_POST['phone']) : ''; ?>"/>
                     <?php if ($phres != "") { ?>
                        <div class>
                            <span class="text-danger"><?php echo $phres; ?></span>
                        </div>
                    <?php } ?>
