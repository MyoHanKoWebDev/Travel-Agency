                ...
                <table class="table table-striped wow fadeInUp" data-wow-delay="0.1s">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td class="text-dark">MMK <?php 
                            echo number_format($serviceChg + $priceFinal, 0, '', ',') ?>
                            </td>
                        </tr>
    ...
    <div class="container-xxl py-5 wow fadeInUp " data-wow-delay="0.5s">
        <div class="container">
            <div class="booking p-5 rounded-3"
                style="background: linear-gradient(rgba(15, 23, 43, .7), rgba(15, 23, 43, .7)),url(../../mainImg/<?php echo $row['pgImg'] ?>); 
            ...
            if (isset($_SESSION['cusArr1']['cusName']) && isset($_SESSION['cusArr1']['cusEmail']) && isset($_SESSION['noInfo']['pgId'])) {
                ...
                if ($result && mysqli_num_rows($result) > 0) {
                    ...
                    echo "<p class='mb-4'>- Hello, <strong class='text-primary'>$customerName!
                    </strong> You are booking the <strong class='text-primary'>$packageTitle</strong> package.</p>";
                    echo "<p class='mb-4'>- A confirmation will be sent to <strong class='text-primary'>
                    $customerEmail</strong> after payment verification.</p>";
