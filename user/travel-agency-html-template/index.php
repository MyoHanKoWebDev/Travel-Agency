                ...
                <div class="col-lg-3 col-sm-6 wow fadeInUp" data-wow-delay="0.7s">
                    <div class="service-item rounded-3 pt-3" style="height: 300px;">
                        <div class="p-4">
                            ...
                            <p>With our user-friendly platform and dedicated team,
                             customers can access travel details, book trips, and receive support anytime, anywhere.</p>
                        </div>
                    </div>
                </div>
            </div>
                ...
                ?>
                    <div class="col-lg-5 col-md-6 wow zoomIn" data-wow-delay="0.7s" style="min-height: 350px;">
                        <a class="position-relative d-block h-100 overflow-hidden" href="readMorePack.php?reMorePg=<?php echo $package["pgID"]; ?>">
                            <img class="img-fluid position-absolute w-100 h-100" src="../../mainImg/<?php echo $popularPackages[3]['pgImg'] ?>" 
    ...
    <div class="container-xxl py-4 wow fadeInUp" data-wow-delay="0.1s">
        <div class="container">
            ...
            <div class="owl-carousel testimonial-carousel position-relative">
                <?php
                $sql = "SELECT f.*, c.cusName,c.cusImg
                        FROM feedback f
                ...
                ?>
                        ...
                        <div class="testimonial-item bg-white text-center border p-4">
                            ...
                            src="../../mainImg/<?php echo $row["cusImg"]; ?>" style="width: 80px; height: 80px;">
