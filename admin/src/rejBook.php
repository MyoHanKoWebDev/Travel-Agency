                                ...
                                <form method="GET" action="" class="bg-white my-3 pb-3 border-bottom">
                                    <div class="row g-3 align-items-center">
                                        <div class="col-md-3">
                                            ...
                                            <input type="text" id="plTitle" name="plTitle" class="form-control rounded-3" 
                                            placeholder="Search By Place Title" value="<?php $_GET['plTitle'] ?? '' ?>">
                                        </div>
                                        ...
                                        <div class="col-md-3">
                                            ...
                                            <input type="number" id="filter" name="filter" placeholder="Type Row Number" class="form-control rounded-3" 
                                            value="<?php $_GET['filter'] ?? '' ?>">
                                        </div>
                                        ...
                                        <div class="text-center col-md-3">
                                            <a href="rejBook.php" class="btn btn-gradient-info btn-end w-100 py-3 rounded-3">
                                        ...
                                        <tbody>
                                            ...
                                            ?>
                                                    <tr>
                                                        ...
                                                        <td class="text-danger fw-bold"><?php echo $row['bstatus'] ?></td>
                                                    </tr>
                                            <?php
                                                } // End of while loop
                                            } // End of if condition 
