                ...
                <div class="card-body">
                  ...
                  $sql = "SELECT COUNT(*) AS total_packages
                          FROM (
                              ...
                              JOIN package pg ON pg.pgID = bd.pgID
                ...
                <div class="card-body">
                  <div class="row">
                    ...
                    <div class="col-md-6 form-group row ">
                      ...
                      <div class="col-sm-6 ">
                        <input type="number" class="form-control border-warning" name="year" id="year" 
                        min="2024" max="<?php echo $manYear = date("Y"); ?>" placeholder="Filter By Year" onkeydown="filterDiaUser(event,this)">
                      </div>
                    </div>
                  </div>
                  <script>
                      ...
                      <tbody>
                        ...
                        ?>
                            <tr>
                              ...
                              <td> <?php echo $rowDia['total_bookings']; ?></td>
