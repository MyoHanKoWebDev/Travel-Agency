                    ...
                    <div class="col-lg-5 mx-auto ">
                        <div class="auth-form-light text-left p-5 rounded-5 border border-dark-subtle">
                            <div class="brand-logo">
                                <p class="brand-logo brand-logo text-info fs-3 fw-bold text-center"><img class="img-fluid me-2" src="../../mainImg/earth (1).png" 
                                alt="" style="width: 50px;height:45px;">Travel Agency</p>
                            </div>
