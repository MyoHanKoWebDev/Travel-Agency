...
if (isset($_POST["upHotel"])) {
  ...
  $sqlTest = "SELECT * FROM hotel WHERE hoName = '$upHoName' AND hoAdd = '$upHoAdd'";
  $resultTest = mysqli_query($con, $sqlTest);
  if (mysqli_num_rows($resultTest) > 0) {
    echo "<script> 
        alert('" . $upHoName . " with  ". $upHoAdd ." already existed.Cannot Update');
                  ...
                  ?>
                      <form class="forms-sample" method="post">
                        ...
                        <div class="form-group">
                          ...
                          <input type="number" class="form-control" id="exampleInputHoRa" placeholder="" 
                          value="<?php echo substr($rowHo['hoRating'], 0, 1); ?>" name="hoRate" required>
                        </div>
